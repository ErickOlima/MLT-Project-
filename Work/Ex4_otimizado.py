...
passo_centrado = 10 # passo da diferenças finitas
n_iterations = 10 # número de iterações
n_layers = [8] # número máximo  de layer
n_max_neuronios_per_layer = 1000 # número máximo  de neuronios por camada
cl = [rn.neural_net_interno_2_hidden, rn.neural_net_interno_3_hidden, rn.neural_net_interno_4_hidden, rn.neural_net_interno_5_hidden, rn.neural_net_interno_6_hidden, rn.neural_net_interno_7_hidden, rn.neural_net_interno_8_hidden]

print(" ---- treinando e validando a rede ---- ")
with tqdm.tqdm(total=(3+3*3)*n_iterations) as pbar:
    ...
    for activation_func in activation_func_list:
        ...
        for n_l in n_layers:
            ...
            with open(f"Work\{origin_path}\Erros5.txt", "w") as file:
