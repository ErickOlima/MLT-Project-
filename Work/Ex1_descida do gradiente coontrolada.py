...
def processamento_agrupado(model_class, neuronios, activation_func, x_true, y_true, xf, func, error_func):
    ...
    plotagem_1d_modelo(xf, func, y_pred, y_true, loss, "y = x³",text)
...
with tqdm.tqdm(total=len(activation_func_list)*n_iterations*n_max_layers) as pbar:
    ...
    for activation_func in activation_func_list:
        ...
        for neuronios_1 in (n_neuronios_inicial, n_neuronios_inicial+passo_centrado):
            ...
            error_measure = processamento_agrupado(rn.neural_net_interno_1_hidden, [neuronios_1], activation_func, x_true, y_true, xf, func, error_func)
        ...
        for i in range(n_iterations-1):
            ...
            error_measure = error_measure = processamento_agrupado(rn.neural_net_interno_1_hidden, [neuronios_1], activation_func, x_true, y_true, xf, func, error_func)
            dict_erros[activation_func][neuronios_1] = error_measure
        ...
        for i in range(n_iterations):
            ...
            error_measure_old = processamento_agrupado(rn.neural_net_interno_2_hidden, neuronios, activation_func, x_true, y_true, xf, func, error_func)
            ...
            error_measure = processamento_agrupado(rn.neural_net_interno_2_hidden, [neuronios[0] + passo_centrado, neuronios[1]], activation_func, x_true, y_true, xf, func, error_func)
            ...
            error_measure = processamento_agrupado(rn.neural_net_interno_2_hidden, [neuronios[0], neuronios[1] + passo_centrado], activation_func, x_true, y_true, xf, func, error_func)
        ...
        for i in range(n_iterations):
            grad = []
            print(f" - com {neuronios[0]} neuronios na 1ª camada; \n \t {neuronios[1]} neuronios na 2ª camada; \n \t e {neuronios[2]} neuronios na 2ª camada")
            
            error_measure_old = processamento_agrupado(rn.neural_net_interno_3_hidden, neuronios, activation_func, x_true, y_true, xf, func, error_func)
            dict_erros[activation_func][f"{neuronios[0]},{neuronios[1]},{neuronios[2]}"] = error_measure_old
            
            #rodadndo para determinação da derivada do número de neuronios na 1ª camada
            print(f" - com {neuronios[0]+passo_centrado} neuronios na 1ª camada; \n \t {neuronios[1]} neuronios na 2ª camada; \n \t e {neuronios[2]} neuronios na 2ª camada")
        
            error_measure = processamento_agrupado(rn.neural_net_interno_3_hidden, [neuronios[0] + passo_centrado, neuronios[1], neuronios[2]], activation_func, x_true, y_true, xf, func, error_func)
            ...
            error_measure = processamento_agrupado(rn.neural_net_interno_3_hidden, [neuronios[0], neuronios[1] + passo_centrado, neuronios[2]], activation_func, x_true, y_true, xf, func, error_func)
            ...
            print(f" - com {neuronios[0]} neuronios na 1ª camada; \n \t {neuronios[1]} neuronios na 2ª camada; \n \t e {neuronios[2] + passo_centrado} neuronios na 2ª camada")
        
            error_measure = processamento_agrupado(rn.neural_net_interno_3_hidden, [neuronios[0], neuronios[1], neuronios[2] + passo_centrado], activation_func, x_true, y_true, xf, func, error_func)
